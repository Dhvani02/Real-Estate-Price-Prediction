...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 11 18:08:25 2018
...
print('RMSE for Mulitple Linear Regression is {:.4f}'.format(sqrt(mean_squared_error(y_test, y_pred))))
regressor_d.score(X_test,y_test)

############RandomForestRegressor############
from sklearn.ensemble import RandomForestRegressor
regressor_r = RandomForestRegressor(n_estimators=300) 
regressor_r.fit(X_train,y_train)
print('RMSE for Random Forest Regression is {:.4f}'.format(sqrt(mean_squared_error(y_test, y_pred))))
